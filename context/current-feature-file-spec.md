...
- Mientras haya una feature activa, `## Notas` debe contener una línea con el formato exacto `- Issue: #<number>` para identificar el issue asociado.
...
- Al iniciar una feature, la sección `## Notas` incluirá la referencia estructurada `- Issue: #<number>` del issue asociado.
